...
SET(STM32_MODULE_PATH ${CMAKE_MODULE_PATH})
...
IF (WIN32)
    ...
    SET(TOOL_SCRIPT_SUFFIX ".cmd")
ELSE()
    SET(TOOL_EXECUTABLE_SUFFIX "")
    SET(TOOL_SCRIPT_SUFFIX ".py")
ENDIF()
...
GET_FILENAME_COMPONENT(CMAKE_SIZE_USAGE "${STM32_MODULE_PATH}/scripts/${TARGET_TRIPLET}-usage${TOOL_SCRIPT_SUFFIX}" ABSOLUTE CACHE)
...
SET(CMAKE_ASM_FLAGS_DEBUG "-g -DDEBUG" CACHE INTERNAL "asm compiler flags debug")
SET(CMAKE_EXE_LINKER_FLAGS_DEBUG "" CACHE INTERNAL "linker flags debug")

SET(CMAKE_C_FLAGS_RELEASE "-Os -flto -DNDEBUG" CACHE INTERNAL "c compiler flags release")
SET(CMAKE_CXX_FLAGS_RELEASE "-Os -flto -DNDEBUG" CACHE INTERNAL "cxx compiler flags release")
SET(CMAKE_ASM_FLAGS_RELEASE " -DNDEBUG" CACHE INTERNAL "asm compiler flags release")
...
FUNCTION(STM32_PRINT_USAGE_OF_TARGETS TARGET)
    IF(EXECUTABLE_OUTPUT_PATH)
      SET(FILENAME "${EXECUTABLE_OUTPUT_PATH}/${TARGET}")
    ELSE()
      SET(FILENAME "${TARGET}")
    ENDIF()
    ADD_CUSTOM_COMMAND(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_SIZE_USAGE} ${CMAKE_SIZE} ${FILENAME} ${MCU_FLASH_SIZE} ${MCU_RAM_SIZE})
ENDFUNCTION()
...
FUNCTION(STM32_SET_TARGET_PROPERTIES TARGET)
    ...
    SET(MCU_FLASH_SIZE ${STM32_FLASH_SIZE} CACHE INTERNAL "flash size")
    SET(MCU_RAM_SIZE ${STM32_RAM_SIZE} CACHE INTERNAL "ram size")
ENDFUNCTION()
